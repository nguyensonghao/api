				...
				<div class="panel">
					...
					<div class="panel-body">
						...
						<div class="btn-group">						
							...
							<button type="button" class="btn btn-danger btn-sm btn-fix-word-{{ $value->id }}" onclick='fixMean({{$value->id}})' word="{{ $value->word }}" mean="{{ $value->mean }}" phonetic="{{ $value->phonetic }}" des="{{ $value->des }}">
